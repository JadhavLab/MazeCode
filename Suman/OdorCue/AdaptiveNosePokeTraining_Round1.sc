% PROGRAM NAME: Adaptive Nose Poke Training — Round 1
% AUTHOR: Suman K. Guha
...
% During phase 0 the animal nose pokes, a beep is played, and reward is displayed. phase 0 is for first 15 rewards.
