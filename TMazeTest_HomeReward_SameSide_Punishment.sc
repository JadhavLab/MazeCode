...
% AUTHOR: 			MD
% DESCRIPTION:
% Full T maze test, containing a sampling phase and a choice phase. Reward delivered to the same side as the sample phase. If choosing the wrong side, set a delay for going back to home port. 

%CONSTANTS

int deliverPeriod= 500   % how long to deliver the reward
int delayPeriod = 10000  % 10 sec delay, can be changed (the same for sample, choice and punishment, can be changed)
int punishPeriod = 15000
