...
callback portin[3] up
	...
	disp(lastWell123)
	disp(lastWellABC)
	if (arrival1==1 && arrivala==1 && lastWell123 !=1) do
...
callback portin[2] up
	...
	disp(lastWell123)
	disp(lastWellABC)
	if (arrival2==1 && arrivalb==1&& lastWell123 !=2) do
...
callback portin[8] up
	...
	disp(lastWell123)
	disp(lastWellABC)
	if (arrival3==1 && arrivalc==1 && lastWell123 != 3) do
...
callback portin[4] up
	...
	disp(lastWell123)
	disp(lastWellABC)
	if (arrivala==1 && arrival1==1 && lastWellABC !=1) do
			disp('Rewarding - position A1 ')
			rewardWell=rewardPump1 	% dispense reward from here
			lastWellABC=1	
			lastWell123=1			
...
callback portin[9] up
	...
	disp(lastWell123)
	disp(lastWellABC)
	if (arrival2==1 && arrivalb==1&& lastWellABC !=2) do
			disp('Rewarding - position C3 ')
			rewardWell=rewardPump2 	% dispense reward from here
			lastWellABC=2	
			lastWell123=2	
...
callback portin[11] up
	...
	disp(lastWell123)
	disp(lastWellABC)
	if (arrival3==1 && arrivalc==1 && lastWellABC !=3) do
			disp('Rewarding - position C3 ')
			rewardWell=rewardPump3 	% dispense reward from here
			lastWellABC=3	
			lastWell123=3			
